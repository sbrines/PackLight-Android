...
class LighterpackServiceTest {
    ...
    fun `export produces valid CSV`() {
        val items = listOf(
            com.stephenbrines.trailweight.data.model.GearItem(
                name = "Test Tent",
                category = com.stephenbrines.trailweight.data.model.GearCategory.SHELTER,
                weightGrams = 700.0,
                quantityOwned = 1,
            )
        )
    ...
    fun `round-trip export then import preserves data`() {
        val items = listOf(
            com.stephenbrines.trailweight.data.model.GearItem(
                name = "Rain Jacket",
                category = com.stephenbrines.trailweight.data.model.GearCategory.CLOTHING,
                weightGrams = 320.0,
                quantityOwned = 1,
                isConsumable = false,
