...
import com.stephenbrines.trailweight.service.GearMetadata
import com.stephenbrines.trailweight.service.UrlMetadataFetcher
...
class GearViewModel @Inject constructor(
    ...
    private val lighterpack: com.stephenbrines.trailweight.service.LighterpackService,
) : ViewModel() {
    ...
    fun importFromCsv(csv: String): com.stephenbrines.trailweight.service.LighterpackResult =
        lighterpack.import_(csv)

    fun importRows(rows: List<com.stephenbrines.trailweight.service.LighterpackRow>) =
